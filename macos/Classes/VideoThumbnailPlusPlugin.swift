...
public class VideoThumbnailPlusPlugin: NSObject, FlutterPlugin {
    ...
    private func generateThumbnailFile(
        ...
        case VideoThumbnailPlusPlugin.FORMAT_WEBP:
            // macOS doesn't have native WebP encoding support, fallback to PNG
            fileExtension = "png"
            imageData = image.pngData()
        default:
            fileExtension = "png"
    ...
    private func generateThumbnailData(
        ...
        case VideoThumbnailPlusPlugin.FORMAT_PNG:
            imageData = image.pngData()
        case VideoThumbnailPlusPlugin.FORMAT_WEBP:
            // macOS doesn't have native WebP support, fallback to PNG
            imageData = image.pngData()
        default:
            imageData = image.pngData()
        }
    ...
    private func createThumbnail(
        ...
        // Use default tolerance for better performance
...
// MARK: - NSImage Extension for image data conversion
extension NSImage {
    func pngData() -> Data? {
